...
const Isolator3P = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "5.5 -4.5 60 60" }, props),
    ...
    React.createElement("symbol", { id: "isolator-3p_svg__A", overflow: "visible" },
        ...
        React.createElement("text", { style: {
            ...
            React.createElement("tspan", { x: 28.004, y: 9 }, "1"),
            React.createElement("tspan", { x: 28.004, y: 46.81 }, "2"),
            React.createElement("tspan", { x: 48.004, y: 9 }, "3"),
            React.createElement("tspan", { x: 48.004, y: 46.81 }, "4"),
            React.createElement("tspan", { x: 68.004, y: 9 }, "5"),
            React.createElement("tspan", { x: 68.004, y: 46.81 }, "6")))));
exports.Isolator3P = Isolator3P;
exports.Isolator3P.metadata = {
    width: 60,
    height: 60
};
