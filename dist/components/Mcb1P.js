...
const SvgMcb1P = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "-10 -10 51 71" }, props),
    ...
    React.createElement("use", { xlinkHref: "#mcb-1p_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "mcb-1p_svg__A", overflow: "visible" },
        ...
        React.createElement("path", { fill: "none", strokeWidth: 0.5, d: "M20 0v15m0 35V35l-5-20m2.181 9.039-2.768.717L13.648 22l-2.768.717.763 2.756-2.768.717" }),
        React.createElement("path", { fill: "#000", fillOpacity: 0.99, strokeWidth: 0.5, d: "M14.087 27.427 9.5 30.038l5.268.337z" }),
        React.createElement("path", { fill: "none", strokeWidth: 0.5, d: "m18.14 28.011-3.703.855" }))));
exports.default = SvgMcb1P;
