...
exports.NoContact = void 0;
const React = __importStar(require("react"));
const NoContact = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "-5 -5 25 60" }, props),
    ...
    React.createElement("use", { xlinkHref: "#no-contact_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "no-contact_svg__A", overflow: "visible" },
        React.createElement("path", { fill: "none", strokeWidth: 0.5, d: "M10 0v15M5 15l5 20v15" }),
        React.createElement("text", { fill: "#000", stroke: "none", fontSize: 7, textAnchor: "end" },
            React.createElement("tspan", { x: 8, y: 9 }, "13"),
            React.createElement("tspan", { x: 8, y: 46.81 }, "14")))));
exports.NoContact = NoContact;
exports.NoContact.metadata = {
    width: 20,
    height: 60
};
