...
exports.Isolator2P = void 0;
const React = __importStar(require("react"));
const Isolator2P = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "5.5 -4.5 30 60" }, props),
    ...
    React.createElement("use", { xlinkHref: "#isolator-2p_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "isolator-2p_svg__A", overflow: "visible" },
        React.createElement("g", { fill: "none", strokeWidth: 0.5 },
            React.createElement("path", { d: "M30 0v15m0 35V35l-5-20M50 0v15m0 35V35l-5-20" }),
            React.createElement("path", { strokeDasharray: "1.5 2", d: "M47.5 25h-20" }),
            React.createElement("path", { d: "M27.5 15h5m15 0h5" })),
...
exports.Isolator2P = Isolator2P;
exports.Isolator2P.metadata = {
    width: 30,
    height: 60
};
