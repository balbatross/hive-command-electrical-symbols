...
exports.Isolator3PLock = void 0;
const React = __importStar(require("react"));
const Isolator3PLock = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "5.5 -4.5 75 60" }, props),
    ...
    React.createElement("use", { xlinkHref: "#isolator-3p-lock_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "isolator-3p-lock_svg__A", overflow: "visible" },
        React.createElement("g", { fill: "none", strokeWidth: 0.5 },
            React.createElement("path", { d: "M30 0v15m0 35V35l-5-20M50 0v15m0 35V35l-5-20M27.5 15h5m15 0h5" }),
            React.createElement("path", { strokeDasharray: "1.5 2", d: "M67 25H10" }),
            React.createElement("path", { d: "M10 22v6m12-8v2.5M70 0v15m0 35V35l-5-20M67.5 15h5M15 25v-3h5v3" })),
...
exports.Isolator3PLock = Isolator3PLock;
exports.Isolator3PLock.metadata = {
    width: 75,
    height: 60
};
