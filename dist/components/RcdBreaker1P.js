...
exports.RcdBreaker1P = void 0;
const React = __importStar(require("react"));
const RcdBreaker1P = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "5.5 -4.5 20 60" }, props),
    ...
    React.createElement("use", { xlinkHref: "#rcd-breaker-1p_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "rcd-breaker-1p_svg__A", overflow: "visible" },
        React.createElement("path", { fill: "none", strokeWidth: 0.5, d: "M20 0v15m0 35V35l-5-20" }),
        React.createElement("path", { fill: "#000", fillOpacity: 0.99, strokeWidth: 0.5, d: "m13.395 24.446-4.587 2.611 5.268.337z" }),
        React.createElement("g", { fill: "none" },
            React.createElement("path", { strokeWidth: 0.5, d: "m17.449 25.03-3.703.855M8 29.25l-1.103-3.845M4.565 28.154l2.884-.827" })),
        React.createElement("text", { fill: "#000", stroke: "none", fontSize: 7, textAnchor: "end" },
            React.createElement("tspan", { x: 18.001, y: 9 }, "1"),
            React.createElement("tspan", { x: 18.001, y: 46.81 }, "2")))));
exports.RcdBreaker1P = RcdBreaker1P;
exports.RcdBreaker1P.metadata = {
    width: 30,
    height: 60
};
