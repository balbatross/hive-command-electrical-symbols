...
exports.FuseDisconnector1P = void 0;
const React = __importStar(require("react"));
const FuseDisconnector1P = (props) => (React.createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#fff", fillRule: "evenodd", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", fontFamily: "Roboto", fontSize: 14, textAnchor: "middle", viewBox: "5.5 -4.5 20 60" }, props),
    ...
    React.createElement("use", { xlinkHref: "#fuse-disconnector-1p_svg__A", x: 0.5, y: 0.5 }),
    React.createElement("symbol", { id: "fuse-disconnector-1p_svg__A", overflow: "visible" },
        React.createElement("g", { strokeWidth: 0.5 },
            React.createElement("path", { fill: "none", strokeDasharray: "1.5 2", d: "M17 25h-7" }),
            React.createElement("path", { d: "m13.791 20.817 4.83-1.294 2.588 9.659-4.83 1.294z" }),
            React.createElement("g", { fill: "none" },
                React.createElement("path", { d: "M20 0v15m-5 0 5 20v15M10 22.5v5M17.5 15h5" }))),
...
exports.FuseDisconnector1P = FuseDisconnector1P;
exports.FuseDisconnector1P.metadata = {
    width: 20,
    height: 60, //23
};
