...
export const Isolator1PLock = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#isolator-1p-lock_svg__A" x={0.5} y={0.5} />
    <symbol id="isolator-1p-lock_svg__A" overflow="visible">
      <g fill="none" strokeWidth={0.5}>
        <path d="M30 0v15m0 35V35l-5-20M27.5 15h5" />
        <path strokeDasharray="1.5 2" d="M27.5 25H10" />
