...
const SvgRcdBreaker1P = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#rcd-breaker-1p_svg__A" x={0.5} y={0.5} />
    <symbol id="rcd-breaker-1p_svg__A" overflow="visible">
      <path fill="none" strokeWidth={0.5} d="M20 0v15m0 35V35l-5-20" />
      <path
        fill="#000"
        fillOpacity={0.99}
        strokeWidth={0.5}
        d="m13.395 24.446-4.587 2.611 5.268.337z"
      />
      <g fill="none">
        <path
          strokeWidth={0.5}
          d="m17.449 25.03-3.703.855M8 29.25l-1.103-3.845M4.565 28.154l2.884-.827"
        />
      </g>
...
export default SvgRcdBreaker1P;
