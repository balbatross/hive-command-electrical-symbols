...
export const Isolator2PLock = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#isolator-2p-lock_svg__A" x={0.5} y={0.5} />
    <symbol id="isolator-2p-lock_svg__A" overflow="visible">
      <g fill="none" strokeWidth={0.5}>
        <path d="M30 0v15m0 35V35l-5-20M50 0v15m0 35V35l-5-20M27.5 15h5m15 0h5" />
        <path strokeDasharray="1.5 2" d="M47.5 25H10" />
        <path d="M10 22.5v5M22.5 20v2.5M15 25v-3h5v3" />
      </g>
