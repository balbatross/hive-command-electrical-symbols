...
export const Isolator3P = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#isolator-3p_svg__A" x={0.5} y={0.5} />
    <symbol id="isolator-3p_svg__A" overflow="visible">
      <path
        d="M30 0v15M30 50V35l-5-20M50 0v15M50 50V35l-5-20M70 0v15M70 50V35l-5-20"
        className="isolator-3p_svg__F isolator-3p_svg__G"
      />
      <path
      ...
      />
      <path
        d="M27.5 15h5M47.5 15h5M67.5 15h5"
        className="isolator-3p_svg__F isolator-3p_svg__G"
      />
      <text
        style={{
      ...
      >
        ...
        <tspan x={28.004} y={46.81}>
          {"2"}
        </tspan>
        <tspan x={48.004} y={9}>
          {"3"}
        </tspan>
        <tspan x={48.004} y={46.81}>
          {"4"}
        </tspan>
        <tspan x={68.004} y={9}>
          {"5"}
        </tspan>
        <tspan x={68.004} y={46.81}>
          {"6"}
        </tspan>
      </text>
    </symbol>
