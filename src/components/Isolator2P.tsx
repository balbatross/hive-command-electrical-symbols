...
export const Isolator2P = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#isolator-2p_svg__A" x={0.5} y={0.5} />
    <symbol id="isolator-2p_svg__A" overflow="visible">
      <g fill="none" strokeWidth={0.5}>
        <path d="M30 0v15m0 35V35l-5-20M50 0v15m0 35V35l-5-20" />
        <path strokeDasharray="1.5 2" d="M47.5 25h-20" />
        <path d="M27.5 15h5m15 0h5" />
      </g>
