...
const SvgNcContact = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#nc-contact_svg__A" x={0.5} y={0.5} />
    <symbol id="nc-contact_svg__A" overflow="visible">
      <path fill="none" strokeWidth={0.5} d="M17.5 15 10 35v15" />
      <path fill="none" strokeWidth={0.5} d="M10 0v18h10" />
