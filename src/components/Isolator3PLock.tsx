...
export const Isolator3PLock = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#isolator-3p-lock_svg__A" x={0.5} y={0.5} />
    <symbol id="isolator-3p-lock_svg__A" overflow="visible">
      <g fill="none" strokeWidth={0.5}>
        <path d="M30 0v15m0 35V35l-5-20M50 0v15m0 35V35l-5-20M27.5 15h5m15 0h5" />
        <path strokeDasharray="1.5 2" d="M67 25H10" />
        <path d="M10 22v6m12-8v2.5M70 0v15m0 35V35l-5-20M67.5 15h5M15 25v-3h5v3" />
      </g>
      <text
        style={{
          stroke: "none",
