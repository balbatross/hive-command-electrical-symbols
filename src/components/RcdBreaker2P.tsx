...
const SvgRcdBreaker2P = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#rcd-breaker-2p_svg__A" x={0.5} y={0.5} />
    <symbol id="rcd-breaker-2p_svg__A" overflow="visible">
      <path
        fill="none"
        d="M40 0v15m0 35V35l-5-20"
        className="rcd-breaker-2p_svg__B"
      />
      <path
        fillOpacity={0.99}
        d="m33.297 24.446-4.587 2.611 5.268.337z"
        className="rcd-breaker-2p_svg__B rcd-breaker-2p_svg__C"
      />
      <g fill="none">
        <path
          d="m37.351 25.03-3.703.855m-5.713 3.085-1.103-3.845M24.5 27.874l2.884-.827M20 0v15m0 35V35l-5-20"
          className="rcd-breaker-2p_svg__B"
        />
      </g>
      <path
      ...
      <text
        className="rcd-breaker-2p_svg__C"
        style={{
          stroke: "none",
          textAnchor: "end",
          fontSize: 7,
...
export default SvgRcdBreaker2P;
