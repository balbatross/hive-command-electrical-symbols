...
export const FuseDisconnector1P = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#fuse-disconnector-1p_svg__A" x={0.5} y={0.5} />
    <symbol id="fuse-disconnector-1p_svg__A" overflow="visible">
      <g strokeWidth={0.5}>
        <path fill="none" strokeDasharray="1.5 2" d="M17 25h-7" />
        <path d="m13.791 20.817 4.83-1.294 2.588 9.659-4.83 1.294z" />
        <g fill="none">
          <path d="M20 0v15m-5 0 5 20v15M10 22.5v5M17.5 15h5" />
        </g>
      </g>
