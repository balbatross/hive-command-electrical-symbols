...
const SvgAcCoil = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <use xlinkHref="#ac-coil_svg__A" x={0.5} y={0.5} />
    <symbol id="ac-coil_svg__A" overflow="visible">
      <path d="M10 20h20v10H10z" className="ac-coil_svg__E" />
      <path fill="none" d="M20 0v20M20 30v20" className="ac-coil_svg__E" />
      <path d="M0 20h10v10H0z" className="ac-coil_svg__E" />
      <path
        d="m1.14 25.042 1.433-1.91c.172-.203.382-.323.593-.323s.409.115.58.318l2.648 3.745c.172.203.346.318.557.318s.409-.115.58-.318l1.33-1.831"
        className="ac-coil_svg__E"
      />
      <text
        fontSize={7}
        style={{
